...
def posts(request):
    ...
    return render(request, 'portifolio/posts.html', context)
...
def createPost(request):
    ...
    context = {'form':form}
    return render(request, 'portifolio/post_form.html', context)
...
def deletePost(request, slug):
    ...
    if request.method == 'POST':
        ...
        return redirect('posts')
    context = {'item':post}
    return render(request, 'portifolio/delete.html', context)
...
def sendEmail(request):
    ...
    if request.method == 'POST':
        ...
        template = render_to_string('portifolio/email_template.html', {
...
def registerPage(request):
    ...
    context = {'form':form}
    return render(request, 'portifolio/register.html', context)
...
def userAccount(request):
    ...
    return render(request, 'portifolio/account.html', context)
